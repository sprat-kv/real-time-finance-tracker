...
def get_expenses():
    """Fetch all expenses from the database with optional filters."""
    ...
    query = "SELECT id, user_id, expense, category, timestamp FROM expenses WHERE user_id = %s"
    params = [user_id]
    ...
    return jsonify({"expenses": expense_list, "categories": categories})
